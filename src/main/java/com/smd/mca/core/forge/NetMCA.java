...
import com.smd.mca.client.gui.GuiStaffOfLife;
import com.smd.mca.client.gui.GuiWhistle;
import com.smd.mca.client.network.ClientMessageQueue;
import com.smd.mca.core.MCA;
import com.smd.mca.core.minecraft.ProfessionsMCA;
import com.smd.mca.entity.EntityVillagerMCA;
import com.smd.mca.entity.data.SavedVillagers;
import com.smd.mca.entity.inventory.InventoryMCA;
import com.smd.mca.items.ItemBaby;
import com.smd.mca.server.ServerMessageHandler;
...
public class NetMCA {
    public static final SimpleNetworkWrapper INSTANCE = NetworkRegistry.INSTANCE.newSimpleChannel("com/smd");
